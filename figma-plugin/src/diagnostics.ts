...
// Info diagnostics (e.g. VDT011 "normalization required") are noise next to real blockers.
...
// Conversion succeeded, but Android would still flag the output (e.g. VDT016 for icons over 200dp).
